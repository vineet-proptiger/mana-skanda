          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <p style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 14px', textAlign: 'justify' }}>
                <TypewriterText text="The Right Life is a premier residential development by Mana Skanda. Located in Sarjapur Road, Bangalore East, it is built across a wide, master-planned area. Known for creating homes designed with love and foresight, Mana Skanda ensures every space resonates with warmth, luxury, and world-class craftsmanship. Our commitment to excellence is exemplified in projects approved by Karnataka RERA, offering families a tranquil lifestyle where schools, IT centers, and modern urban conveniences are merely a whisper away." />
              </p>
            </div>
