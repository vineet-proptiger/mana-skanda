...
const units = [
  {
    ...
    btnText: "Get Details",
    features: [
      "Luxurious 2 BHK layout",
      "Homes built with love & foresight",
      "World-class fittings & finishes",
  ...
  },
  {
    ...
    btnText: "Get Details",
    features: [
      "Spacious 3 BHK premium suite",
      "Abundant natural light & ventilation",
      "World-class fittings & finishes",
      "Schools merely a whisper away"
    ]
  },
  {
    ...
    btnText: "Get Details",
    features: [
      "Expansive 4 BHK grand residences",
      "Exclusive master-planned lifestyle",
      "Panoramic skyline & green views",
      "Ultimate privacy & sophistication"
    ]
  }
];
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#D5C2A8]">
            {units.map((unit, idx) => (
              <div key={idx} className="p-6 lg:p-8 relative flex flex-col justify-between">
                <div>
                  {/* Title & Size */}
                  <h3
