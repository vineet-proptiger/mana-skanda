      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '48px' }}>
          ...
          <a href="#" style={{ flexShrink: 0, display: 'flex', alignItems: 'center' }}>
            <style>{`
              .nav-logo { height: 54px; width: auto; display: block; object-fit: contain; transform: scale(1.1, 1.05); transform-origin: center; }
              @media(max-width: 768px) {
                .nav-logo { height: 46px; transform: scale(1.06, 1.02); }
              }
            `}</style>
            <img
              src={logoImages.main}
              alt="Mana Skanda The Right Life Logo"
              className="nav-logo"
            />
          </a>
